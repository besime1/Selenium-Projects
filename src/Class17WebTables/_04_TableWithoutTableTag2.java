...
//        }
        ...
        driver.findElement(By.cssSelector("#firstName")).sendKeys("Besime");
        driver.findElement(By.cssSelector("#lastName")).sendKeys("Demir");
        driver.findElement(By.cssSelector("#userEmail")).sendKeys("besimedemir2021@gmail.com");
        driver.findElement(By.cssSelector("#age")).sendKeys("36");
