...
public class _04_TableWithoutTableTag3 extends BaseClass{
    public static void main(String[] args) {
        ...
        driver.findElement(By.cssSelector("input[id='firstName']")).sendKeys("Besime");
        driver.findElement(By.cssSelector("input[id='lastName']")).sendKeys("Demir");
        driver.findElement(By.cssSelector("input[id='userEmail']")).sendKeys("besimedemir2021@gmail.com");
        driver.findElement(By.cssSelector("input[id='age']")).sendKeys("36");
        driver.findElement(By.cssSelector("input[id='salary']")).sendKeys("4000");
