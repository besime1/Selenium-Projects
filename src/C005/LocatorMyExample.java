...
public class LocatorMyExample {
     ...
     */
        ...
        //Main method oluşturun ve aşağıdaki görevi tamamlayın.
            ...
            System.setProperty("webdriver.chrome.driver.exe", "src/resources/drivers/chromedriver.exe");
            ...
            //	b. Sign in butonuna basin
            WebElement signInLinki = By.id("sign-in").findElement(driver);
            signInLinki.click();
